...
const doctors = [
...

  {
    ...
    certifications: "Cosmetic Dentistry Diploma",
...

  {
    ...
    consultationDuration: 30,
    certifications: "Gynecology & Obstetrics Board",
...

  {
    ...
    availabilityDays: "Mon - Fri",
    consultationDuration: 30,
    certifications: "Orthopedic Surgery Diploma",
...

  {
    ...
    availabilityDays: "Mon - Fri",
    consultationDuration: 20,
    certifications: "Pediatrics Certificate",
...
const seedDoctor = async () => {
  try {
    ...
    console.log("✅ Doctor seeder executed successfully!");
    process.exit(0);
  } catch (error) {
